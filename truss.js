...
(function (global) {
  ...
  var TIERS = {
    lite: { key:"lite", name:"Core", rank:1, mo:650, build:0, desc:"Core practice. Pursuits, fees, the project spine, the module workflow, calcs and billing.", base:"Single office · up to 6 engineers", includes:["pursuits","proposals","projects","workflow","calcs","billing"] },
    standard: { key:"standard", name:"Elite", rank:2, mo:1400, build:0, desc:"The working firm. Adds the PE-seal gate, permits, the multiplier board, HR, IT — and the agent org.", base:"Single office · up to 20 engineers", includes:["pursuits","proposals","projects","workflow","calcs","billing","seal","permits","books","hr","it","org"] },
    grandsuite: { key:"grandsuite", name:"Mothership", rank:3, mo:3200, build:0, desc:"The whole firm, nothing held back. Every department, the full agent org, the Modules engine, and contracts.", base:"Multi-office · unlimited seats · dedicated environment · data migration", includes:["pursuits","proposals","projects","workflow","calcs","billing","seal","permits","modules","books","hr","it","law","org"] }
  };
  var DEPTS = [
